...
<!--                                 <vue-editor v-model="content.description_work"
                              ...
                              <b-button class="customButton btn-outline-secondary" @click="checkInEditor('t'+tableId + 'x' + subIndex, content.id)"
                              style="position:relative;left:24px;top: 6px;width:18px;z-index:2;"><i class="fas fa-calculator"></i></b-button>
                              
                              <span v-show="(disablefildUser(('t'+tableId + 'x' + subIndex), content.id)!='you')" style="position:relative;left:30px;top: 6px;width:18px;z-index:2;">
