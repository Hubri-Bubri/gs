                      ...
                      <b-form-row @mouseover="(type!='Invoices')?content.upHere = true:''" @mouseleave="(type!='Invoices')?content.upHere = false:''" 
                       :class="{howerRow: content.upHere, '': !content.upHere}" :key="content.id" class="formrowwrap">
                        ...
                        <div  class="tposition text-center" v-show="showPos">
                           <b-input size="sm" @click.prevent.self :disabled="disablefild('position_number', content.id)" type="text" placeholder="Unit" :style="(content.done!=false) ? 'color:green' : ''"
                        ...
                        <div class="tdeschead text-center" :style="'width:'+computedWithDesc(value.parts.checkbox_list.flavours)+'%'">
                           <b-input  size="sm" @click.prevent.self :disabled="disablefild('desk_head', content.id)" type="text" placeholder="Description Head" class="cForm-input"
                        ...
                        <div  class="tcount text-center">
                           <b-input  size="sm" @click.prevent.self :disabled="disablefild('count', content.id)" @focus.native="$event.target.select();changeDisable('f', 'count', content.id);" type="text" :tabindex="(((tableId)*10)+(subIndex+1))"
                        ...
                        <div  class="tunit text-center">
                           <b-select  size="sm" :value="valOrProc(content, subIndex)" :disabled="disablefild('unit', content.id)"
                        ...
                        <div class="tprice text-right" style="font-weight: normal;">
                           <b-input  size="sm" v-if="content.unit!='%'" :disabled="disablefild('price', content.id)" @click.prevent.self type="text"
                           @focus.native="$event.target.select();changeDisable('f', 'price', content.id);"
                             ...
                             :value="content.price.replace('.',',')" :style="(content.done!=false) ? 'color:green' : ''"
...
value.parts.checkbox_list.selected, value.parts.part_content, '%') )}}  -->
                        ...
                        <div class="tcalc text-center">
                           <b-form-select  size="sm" class="select" :disabled="disablefild('calc', content.id)" style="min-width:45px" :options="calc" @change="sendDataTable(content.id, 'status', $event)"
                     ...
                     <b-form-row v-if="edopen=='desk_worck'+tableId+subIndex">
