...
<b-modal class="mail" v-model="tabxmodal" centered no-close-on-esc no-close-on-backdrop hide-header-close>
  <template #modal-header>
    ...
    <b-link @click="menuPriceTree=menuPriceTree?false:true" v-if="comtomodal=='pricelist'">Price List</b-link>
    <b-link @click="menuDevicesTree=menuDevicesTree?false:true" v-if="comtomodal=='deviceslist'">Devices List</b-link>
    <b-link @click="menuDocsTree=menuDocsTree?false:true" v-if="comtomodal=='docs'">Docs</b-link>
...
<b-button class="customButton btn-outline-secondary" @click="checkInEditor('refCommentOfTable1', tmp.id)" 
style="position:relative;left:24px;top: 6px;width:18px;z-index:2;"><i class="fas fa-calculator"></i></b-button>
<vue-editor :value="tmp.comment" :editorToolbar="customToolbar"
style="position:relative;top:-20px;z-index:1;" 
class="text-right"  ref="refCommentOfTable1" id="refCommentOfTable1"
@mouseleave.native="updateItem($refs['refCommentOfTable1'].quill.getHTML(), 'comment', tmp.id);tmp.comment=$refs['refCommentOfTable1'].quill.getHTML()" />
...
<b-tab style="padding:0px;"  >
                        ...
                        <container-footer>
                                    ...
                                    <b-collapse v-model="dropDoc" id="dropDoc3">
                                        <vue-dropzone ref="myVueDropzone3" id="dz3" :options="dropzoneOptions" v-on:vdropzone-sending="sendingEvent"
                          ...
                          <b-form-row>
                              <b-col lg="1" cols="12" style="padding:1px;">
                                <b-button class="w-100" @click="dropDoc=dropDoc?false:true">
                                  <i style="color:#fecb53;" :class="dropDoc?'fa fa-folder-open':'fa fa-folder'" aria-hidden="true"></i>
                                </b-button>
                              </b-col>
                              <b-col lg="1" cols="12" style="padding:1px;"><b-button class="w-100" @click="addDoc">+Part</b-button></b-col>
                              <b-col lg="8" cols="12" style="padding:1px;"><b-form-input class="w-100" v-model="nameNodeDoc" :style="nodeDisDoc?'background-color:grey':''"
                                  @click.native="nodeDisDoc?nodeDisTurnDoc():''" @change="nodeDisDoc=true;toModelDoc(nameNodeDoc)"></b-form-input>
                              </b-col>
                              <b-col lg="1" cols="12" style="padding:1px;"><b-button class="w-100" style="padding-left:0px;padding-right:0px;" @click="removeDoc">Remove</b-button></b-col>
                              <b-col lg="1" cols="12" style="padding:1px;"><b-button class="w-100" @click="moveDoc">Move</b-button></b-col>
                          </b-form-row>
...
<span v-show="(disablefildUser('refCommentOfTable', tmp.id)!='you')" style="position:relative;left:30px;top: 26px;width:18px;z-index:2;"
...
class="text-right"  ref="refCommentOfTable" id="refCommentOfTable"
 ...
 />
                                        ...
                                        <b-input-group class="cForm-input">
                                            <b-input-group-prepend>
                                                <b-link class="input-group-text lablelInInput" style="text-decoration: none;font-weight: normal;"
