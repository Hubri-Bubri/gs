                    ...
                    <b-tabs card>
                        ...
                        <b-tab title="Images">
                          ...
                          <container>
                            <container-body  style="overflow-x: hidden;">
                             <images
                             :domageImages="domageImagesSub"
                             :fieldsImages="fieldsImages"
                             :selectedDamageImages="selectedDamageImagesSub"
                             :optImages="optImages"
                             :className="'sub'"
...
<b-tab title="Docs">
                        ...
                        <b-tab title="Images">
                          ...
                          <container>
                            <container-body  style="overflow-x: hidden;" >
                             <images
                             :domageImages="domageImagesSperson"
                             :fieldsImages="fieldsImages"
    ...
    getdomageFilesCustomer(id){
      ...
      getdomageImagesCustomer(id){
       axios.get('/domage_images_sub', {
        ...
        this.domageImagesSub = response.data.filter(function (v){
      ...
      getdomageFilesPerson(id){
        // console.log(id)
       axios.get('/domage_images_sperson', {
          params: {
            id: id
          }
        }).then(response => {
      ...
      getdomageImagesPerson(id){
       axios.get('/domage_images_sperson', {
        ...
        this.domageImagesSperson = response.data.filter(function (v){
          if(v.file_name != undefined){
            if((v.file_name.split('.')[v.file_name.split('.').length-1]) != 'pdf'){ return v}
          }
        })
