<template>
<div>
<vue-editor v-model="project.other" :editorToolbar="customToolbar"
                                 style="height:82vh" v-if="(tmp.number==null)"
                                 @mouseleave.native="updateProject('other', project.other)" />
                                              ...
                                              <b-col :lg="(tmp.type!='Damage Description')?6:12" md="12" >
                                                ...
                                                <b-form-row>
                                                  ...
                                                  <b-col sm="8" cols="12" >
                                                    ...
                                                    countDigitals(tmp.number.split(' ')[1])+'-'+tmp.number.split(' ')[0].split('-')[1]:(tmp.typeOfHead=='SUB')?tmp.number.split(' ')[0]:
                                                    (tmp.typeOfHead=='Sub Invoices')?tmp.number.split(' ')[3]:tmp.number" placeholder="Enter offer number" class="cForm-input"
