...
<b-container style="padding: 0px;" fluid>
                                  <b-row>
                                            <b-col lg="6" sm="12" class="cuestomRow">
                                              <b-row>
                                                <b-col sm="4" cols="12" class="cForm">{{projectfild.content}}:</b-col>
                                                <b-col sm="8" cols="12" ><b-form-input  :state="null" disabled type="text" :value="project.number" placeholder="Enter project number" class="cForm-input" /></b-col>
                                              </b-row>
                                              <b-row>
                                                <b-col sm="4" cols="12" class="cForm">Start date:</b-col>
                                                <b-col sm="8" cols="12" ><b-form-input  :state="null" type="date" @change="updateProject('date', $event)" :value="project.date" placeholder="Enter date" class="cForm-input"
                                                    :disabled="disablefild('project-start-date', id)" @focus.native="changeDisable('f', 'project-start-date', id)" @blur.native="changeDisable('b', 'project-start-date', id)" :id="'project-start-date'+id"  /></b-col>
                                              </b-row>
                                           ...
                                           <b-col lg="6" sm="12" class="cuestomRow">
                                                <b-row>
                                                <b-col sm="4" cols="12" class="cForm">Editor:</b-col>
                                                <b-col sm="8" cols="12" ><b-form-input :state="null" type="text" disabled :value="project.editor" placeholder="Enter editor name" class="cForm-input"  /></b-col>
                                              </b-row>



                                              <b-row>
                                                <b-col sm="4" cols="12" class="cForm">End date:</b-col>
                                                <b-col sm="8" cols="12" ><b-form-input :min="project.date" :state="null" type="date" @change="updateProject('edate', $event)" :value="project.edate" placeholder="Enter date" class="cForm-input"
                                                    :disabled="disablefild('project-end-date', id)" @focus.native="changeDisable('f', 'project-end-date', id)" @blur.native="changeDisable('b', 'project-end-date', id)" :id="'project-end-date'+id"  /></b-col>
                                              </b-row>
                                 ...
                                 <hr />
                                    ...
                                    <b-col lg="6" sm="12" >
                                      <b-row>
                                              <b-col sm="4" cols="12" class="cForm">Customer:</b-col>
                                                <b-col sm="8" cols="12" >
                                                  <b-input-group>
                                               <!-- <b-button size="sm" class="cForm-inputG" variant="outline-secondary"  @click=""><i class="fa fa-user-plus" aria-hidden="true"></i></b-button> -->
                                                    <b-select label="name" text-field="name"  value-field="id" class="customButton" :value="selectCustomer.id"
                                                    @change="get_person($event, true);updateProject('customer_id', $event);" :options="area" :disabled="area==[]" />
                                                  </b-input-group>
                                                </b-col>
                                   
                                              
                                              <b-col sm="4" cols="12" class="cForm">Contact:</b-col>
                                                <b-col sm="8" cols="12" >
                                                  <b-input-group>
                                                  <b-select text-field="name" value-field="id" class="customButton"  :value="selectPerson.id" :options="availablePersons" @change="get_contact($event);updateProject('person_id', $event);" />
                                                  </b-input-group>
                                                </b-col>
                                      

                                            
                                              <b-col sm="4" cols="12" class="cForm">Phone:</b-col>
                                                <b-col sm="8" cols="12" >
                                                 <b-input-group>
                                                  <b-select  text-field="phone" value-field="phone" class="customButton" :value="selectPhone" :options="availablePhons"  />
                                                 </b-input-group>
                                                </b-col>
                                            

                                            
                                              <b-col sm="4" cols="12" class="cForm">E-mail:</b-col>
                                                <b-col sm="8" cols="12" >
                                            <b-input-group>

                                                <b-button size="sm" class="cForm-inputG" variant="outline-secondary"  @click="$emit('sendMail', availableMails)"><i class="fa fa-envelope" aria-hidden="true"></i></b-button>
                                                 <b-form-select  text-field="mail" value-field="mail" class="customButton" :value="selectMail" :options="availableMails" />
                                            </b-input-group>
                                          </b-col>
                                         ...
                                         <b-col lg="6" sm="12">
                                          <b-row>
                                                ...
                                                <b-col sm="8" cols="12" >
                                                  <b-input-group>
                                              <b-form-input  :state="null" type="text" @change="searchZip($event)" :value="project.zip1" placeholder="Enter zip code" class="cForm-input"
                                                  :disabled="disablefild('pzip1', id)" @focus.native="changeDisable('f', 'pzip1', id)" @blur.native="changeDisable('b', 'pzip1', id)" :id="'pzip1'+id"  />
                                                  <b-select value-field="code" text-field="name" class="customButton"
                                              ...
                                              {{disablefildUser('pzip', id)}}
                                                ...
                                                <b-col sm="4" cols="12" class="cForm">Area:</b-col>
                                                <b-col sm="8" cols="12" >
                                                  <b-input-group>
                                                  <b-form-input  :state="null" type="text" @change="updateProject('area', $event)" :value="project.area" placeholder="Enter area" class="cForm-input"
                                              ...
                                              <b-col sm="4" cols="12" class="cForm">City:</b-col>
                                                <b-col sm="8" cols="12" ><b-input-group>
                                                    <b-form-input  :state="null" type="text" @change="updateProject('city1', $event)" :value="project.city1"
                                                    placeholder="Enter city" class="cForm-input" :disabled="disablefild('pcity1', id)" @focus.native="changeDisable('f', 'pcity', id)"
                                              ...
                                              <b-col sm="4" cols="12" class="cForm">Street:</b-col>
                                                <b-col sm="8" cols="12" >
                                                    <b-input-group>
                                                      <b-button @click="$emit('openmap')" class="cForm-inputG" size="sm" variant="outline-secondary">
                                                            <i class="fa fa-map-marker" aria-hidden="true"></i>
                                                        </b-button>
                                                        <b-form-input :state="null" type="text" @change="updateProject('street1', $event)" :value="project.street1" placeholder="Enter street" class="cForm-inputBeforG" :disabled="disablefild('pstreet1', id)" @focus.native="changeDisable('f', 'pstreet1', id)" @blur.native="changeDisable('b', 'pstreet1', id)" :id="'pstreet1'+id" />
                                                      </b-input-group>
                                                  </b-col>
                                       ...
                                       <b-tooltip triggers="none" :show="disablefild('pstreet', id)" :target="'pstreet'+id">
                                        ...
                                        <b-row>
                                            <b-col>
                                                <b-button class="customButton" @click="addSameModal()">
                                                    Add Offer
                                                </b-button>
                                                <b-button class="customButton" @click="showCommetnts" :disabled="!tmp.id">
                                                    Show comments
                                                </b-button>

                                                  <b-dropdown  text="Link For Workers" class="customDrop">
                                                    <b-dropdown-item  v-for="item in workersForSend" :key="item.id" v-clipboard="'https://'+detecthost()+'/#/project/user/'+id+'/'+item.value" >{{item.text}}</b-link></b-dropdown-item>
                                                  </b-dropdown>
                                            </b-col>
                                        </b-row>
                                        <br/>
 ...
 <Spinner size="large" ></Spinner>
                                   ...
                                   {{name.type}}
                                    ...
                                    :fields="(name.type=='Damage Description')?fieldsTableD:fieldsTable" @row-clicked="inItemGetData">
                                      ...
                                      <template slot="status_set" slot-scope="it" style="height:30px;">
                                          <div style="width:95%;overflow:hidden;">
                                          <line-chart :datas="dataCharts(it.item)" :height="50" style="max-width:200px;" v-if="name.type=='Invoices'"/>
                                    
                                         
                                                <b-form-select v-else style="margin-left:15px;width:90%;" v-model="it.item.status_set" @change="updateItem($event, 'status_set', it.item.id)"
         ...
         <template slot="insurance_number" slot-scope="data">
                                  <div class="text-container">
