                            ...
                            <container>
                                <container-body>
                                  ...
                                  <b-row >
                                    ...
                                    <b-collapse id="dropDoc" visible>
                                        <b-select :options="workers" v-model="user" disabled></b-select>
...
var rows2 = this.getItems('Contracts').filter((v)=>{
    v.type = 'Contracts'
    return v
})
...
axios.get('/get_tables', {
        ...
        sendingEvent(file, xhr, formData) {
            ...
            xhr.setRequestHeader('number', this.project.number);
            xhr.setRequestHeader('group', selectTables);
            xhr.setRequestHeader('user', this.selectedWorkers);
     ...
     axios.get('/project_detail', {
                params: {
                 ...
                 var nuls=3-response.data.id.toString().length
                    ...
                    this.project.number = 'DA-'+response.data.id+'-'+response.data.project_number_year,
